...
class ExecutiveBase(BaseModel):
    ...
    job_title: str = Field(min_length=1, max_length=20)
...
class ExecutiveUpdate(BaseModel):
    ...
    full_name: str | None = Field(default=None, min_length=1, max_length=30)
    job_title: str | None = Field(default=None, min_length=1, max_length=20)
    linkedin_url: str | None = None